...
main() {
  ...
  if [[ $scope == "lab1" ]]; then
    ...
    echo -e "\tscripts/grade.sh [lab1|lab2|lab3|lab4|lab5-part1|lab5-part2|lab6|lab7|all]"
    echo -e "or"
    echo -e "\tmake [gradelab1|gradelab2|gradelab3|gradelab4|gradelab5-1|gradelab5-2|gradelab6|gradelab7|gradeall]"
  fi
}
